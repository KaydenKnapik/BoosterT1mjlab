"""AMP locomotion task base configuration.

Factory function — robot-specific configs call this and customize as needed.
"""
...
import booster_t1_mjlab.tasks.amp_loco.mdp as mdp
...
def make_amp_env_cfg() -> ManagerBasedRlEnvCfg:
    """Create AMP locomotion task base configuration."""
    ...
    terminations = {
        ...
        "bad_base_height": TerminationTermCfg(
            ...
            params={"minimum_height": 0.3},  # Override per-robot.
        ),
    }
